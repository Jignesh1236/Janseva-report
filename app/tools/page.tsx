...
const translations: Record<string, Translations> = {
  en: {
    ...
    textToHandwriting: "Text to Handwriting Converter"
  },
  gu: {
    ...
    textToHandwriting: "ટેક્સ્ટ થી હસ્તલેખન કન્વર્ટર"
  }
};
...
export default function OnlineTools() {
  ...
  const tools: Tool[] = [
    ...
    { 
      ...
      description: 'Convert typed text into handwriting-style text with customizable fonts',
    ...
    { 
      name: 'GST Calculator', 
      description: 'Calculate GST with different tax rates for Indian businesses',
    ...
    { 
      ...
      description: 'Calculate income tax for different slabs and regimes',
    ...
    { 
      name: 'SIP Calculator', 
      description: 'Calculate mutual fund SIP returns and investment growth',
    ...
    { 
      ...
      description: 'Compare different loan offers and find the best deal',
    ...
    { 
      ...
      description: 'Calculate electricity charges based on usage and tariff rates',
    ...
    { 
      ...
      description: 'Calculate water charges based on usage and connection type',
      path: '/tools/water-bill-calculator', 
      icon: '💧', 
      category: 'Utilities'
    },
    { 
      name: 'Mobile Plan Comparator', 
      description: 'Compare different mobile plans from various operators',
      path: '/tools/mobile-plan-comparator', 
      icon: '📱', 
      category: 'Utilities',
      popular: true
    },
    { 
      ...
      description: 'Calculate internet data consumption and get plan recommendations',
      path: '/tools/data-usage-calculator', 
      icon: '📊', 
      category: 'Utilities'
    },
    { 
      name: 'Fuel Cost Calculator', 
      description: 'Calculate fuel expenses for trips with detailed breakdown',
    ...
    { 
      ...
      description: 'Track medication schedules and never miss a dose',
    ...
    { 
      name: 'Health Report Organizer', 
      description: 'Organize and manage all your medical reports digitally',
      path: '/tools/health-report-organizer', 
      icon: '🏥', 
      category: 'Health'
    },
    { 
    ...
    { 
      ...
      description: 'Digital business card creator',
      path: '/tools/business-card-designer', 
      icon: '💼', 
      category: 'Business',
      popular: true
    },
    { 
      name: 'Logo Maker', 
      description: 'Simple logo design tool',
      path: '/tools/logo-maker', 
      icon: '🎨', 
      category: 'Business'
    },
    { 
      name: 'Bill Book Generator', 
      description: 'Create customized bill books',
      path: '/tools/bill-book-generator', 
      icon: '📋', 
      category: 'Business',
      popular: true
    },
    ...
    { 
      ...
      description: 'PO creation tool',
      path: '/tools/purchase-order-generator', 
      icon: '📦', 
      category: 'Business'
    },
    { 
      name: 'Stamp Paper Generator', 
      description: 'Generate digital stamp papers with different denominations',
      path: '/tools/stamp-paper-generator', 
      icon: '📜', 
      category: 'Documents',
      popular: true
    },
    { 
      ...
      description: 'Create various certificates like birth, income, domicile',
    ...
    { 
      ...
      description: 'Generate legal affidavit templates',
      path: '/tools/affidavit-generator', 
      icon: '⚖️', 
      category: 'Documents'
    },
    { 
      name: 'Character Certificate Maker', 
      description: 'School/college character certificates',
      path: '/tools/character-certificate', 
      icon: '🎓', 
      category: 'Documents'
    },
    { 
      name: 'NOC Generator', 
      description: 'No Objection Certificate templates',
      path: '/tools/noc-generator', 
      icon: '📝', 
      category: 'Documents'
    },
    { 
      name: 'Ration Card Application Helper', 
      description: 'Step-by-step ration card application guide',
      path: '/tools/ration-card-helper', 
      icon: '🍽️', 
      category: 'Government'
    },
    { 
      name: 'Passport Form Filler', 
      description: 'Pre-fill passport application forms',
      path: '/tools/passport-form-filler', 
      icon: '🛂', 
      category: 'Government'
    },
    { 
      name: 'Driving License Form Helper', 
      description: 'DL application assistance',
      path: '/tools/driving-license-helper', 
      icon: '🚗', 
      category: 'Government'
    },
    { 
      name: 'Property Registration Helper', 
      description: 'Property documents preparation',
      path: '/tools/property-registration-helper', 
      icon: '🏠', 
      category: 'Government'
    },
  ];
